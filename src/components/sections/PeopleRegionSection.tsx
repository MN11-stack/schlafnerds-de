        ...
        <div className="grid items-start gap-16 md:grid-cols-2">
          ...
          <div>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:gap-6">
              <div className="flex items-center gap-2 text-sm text-tagline">
                <svg
                ...
                <span>
                  <strong>Markus</strong> – Zertifizierter Schlafcoach (IST)
                </span>
              </div>
              <div className="flex items-center gap-2 text-sm text-tagline">
                <svg
                ...
                <span>
                  <strong>Dirk</strong> – Zertifizierter Ergopraktiker
                </span>
              </div>
            </div>

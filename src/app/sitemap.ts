...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    {
      url: `${baseUrl}/bettengeschaeft-muensterland`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    ...
    {
      url: `${baseUrl}/blog/schlaf-im-alter`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: `${baseUrl}/blog/matratze-kaufen`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: `${baseUrl}/blog/nackenstuetzkissen-finden`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: `${baseUrl}/blog/erdungsspanntuecher`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: `${baseUrl}/blog/boxspringbett-oder-lattenrost`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.7,
    },
